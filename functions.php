...
function bz_theme_enqueue_styles() {
	...
	if ( is_page_template( 'page-templates/page-contact.php' ) ) :
		wp_enqueue_script( 'google-map-api', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBAZN5TfX1aWmjodZ4e_6sOcaJV4D59jfo&loading=async&callback=Function.prototype', array(), $theme_version, true );
