...
function theme_logo() {
	...
	<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		viewBox="0 0 155.4 69.2" style="enable-background:new 0 0 155.4 69.2;" xml:space="preserve">
		<path style="fill: #1D1D1B;" d="M155,67.1L101.4,0.4c-0.5-0.6-1.4-0.6-1.9,0L70.4,33.2L50.5,16.1h0l0,0l0,0c-0.5-0.5-1.3-0.4-1.8,0.1v0
