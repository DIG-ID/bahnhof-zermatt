<section class="section-wellness az-container overflow-hidden mb-28 xl:mb-52">
	<div class="az-container-grid">
		...
		<div class="col-span-1 md:col-span-4 xl:col-span-4 col-start-1 xl:col-start-3">
			<h2 class="title-xl max-w-[200px] md:max-w-none mb-5 xl:mb-0 break-words hyphens-auto"><?php the_field( 'wellness_title' ); ?></h2>
		</div>
		<div class="col-span-1 md:col-span-4 xl:col-span-3 col-start-1 md:col-start-5 xl:col-start-8 pb-2">
			<p class="text-body mb-10 md:mb-20 xl:mb-16 max-w-[85%] md:max-w-none"><?php the_field( 'wellness_description' ); ?></p>
			<?php
			$ag_link = get_field( 'wellness_link' );
			if ( $ag_link ) :
