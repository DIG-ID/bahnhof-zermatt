<section id="section-intro" class="section-intro az-container pt-28 xl:pt-48 overflow-hidden">
	<div class="az-container-grid gap-y-3 xl:items-center">
        <div class="col-span-1 md:col-span-8 xl:col-span-3 col-start-1 xl:col-start-3 xl:max-w-[400px] text-center xl:text-left order-2 xl:order-1">
            ...
            <p class="text-body mb-14 xl:mb-0 xl:max-w-[363px] invisible"><?php the_field( 'section_intro_description' ); ?></p>
        </div>
        <div class="col-span-1 md:col-span-8 xl:col-span-4 col-start-1 md:col-start-1 xl:col-start-7 order-1 xl:order-2">
            <?php 
                ...
                if( $intro_image ) {
                    echo wp_get_attachment_image( $intro_image, 'main-header-image-half-container', false, array( 'class' => 'ih-[380px] md:h-[800px] xl:h-[780px] object-cover invisible w-full' ) );
                }
            ?>
        </div>
    </div>
