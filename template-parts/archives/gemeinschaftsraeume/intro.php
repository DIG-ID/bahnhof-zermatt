<section id="section-intro" class="section-intro az-container pt-28 xl:pt-48 xl:pb-40 overflow-hidden">
	<div class="az-container-grid gap-y-3 xl:items-center">
        ...
        <div class="rooms__intro--right relative col-span-1 md:col-span-4 xl:col-span-4 col-start-1 md:col-start-3 xl:col-start-8 max-w-none xl:max-w-[363px] text-center xl:text-left">
            <h1 class="title-xl mb-10 md:mb-12 mt-12 xl:mt-0 "><?php the_field( 'archive_seminare_title', 'option' ); ?></h1>
            <p class="text-body mb-14 xl:mb-0 invisible"><?php the_field( 'archive_seminare_description', 'option' ); ?></p>
        </div>
