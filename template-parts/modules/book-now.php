<div class="fixed-booking-button-wrapper fixed -right-[14px] top-1/2 -translate-y-1/2 lg:flex-col gap-y-16 items-center justify-center hidden invisible lg:flex lg:visible">
	<?php
